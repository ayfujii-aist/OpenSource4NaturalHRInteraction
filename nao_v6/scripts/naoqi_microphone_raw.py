...
# This program is modified from naoqi_microphone.py in the following.
# https://github.com/ros-naoqi/naoqi_bridge/blob/master/naoqi_sensors_py/src/naoqi_sensors/naoqi_microphone.py
...
class NaoqiMic (ALModule, NaoqiNode):
    def __init__(self, name):
        ...
        # ROS publishers
        self.pub_audio_ = rospy.Publisher('~audio', AudioBuffer, queue_size=1)
        self.pub_audio_raw = rospy.Publisher('~audio_raw', AudioData, queue_size=1)
    ...
    def processRemote(self, nbOfInputChannels, fNbOfInputSamples, timeStamp, inputBuff):
        audio_msg_raw = AudioData()
        audio_msg_raw.data=inputBuff
        ...
        self.pub_audio_raw.publish(audio_msg_raw)
